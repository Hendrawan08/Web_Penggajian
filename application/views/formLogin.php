                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h1 class="h4 text-gray-900 mb-4">APLIKASI PENGGAJIAN<br><b>PT. MAJU JAYA</b></h1>
                                    </div>
                                    <?php echo $this->session->flashdata('pesan') ?>
                                    <form class="user" method="post" action="<?php echo base_url('welcome') ?>">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Userame..." name="username">
